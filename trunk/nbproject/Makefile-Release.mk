...
${OBJECTDIR}/Sources/Mesh/CartesianOneDimRegion.o: Sources/Mesh/CartesianOneDimRegion.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Mesh/CartesianOneDimRegion.o Sources/Mesh/CartesianOneDimRegion.cpp

${OBJECTDIR}/Sources/Solution/ScatteringSource.o: Sources/Solution/ScatteringSource.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Solution
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Solution/ScatteringSource.o Sources/Solution/ScatteringSource.cpp

${OBJECTDIR}/Sources/Solver/PijSolver.o: Sources/Solver/PijSolver.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Solver
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Solver/PijSolver.o Sources/Solver/PijSolver.cpp

${OBJECTDIR}/Sources/Mesh/Mesh.o: Sources/Mesh/Mesh.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Mesh
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Mesh/Mesh.o Sources/Mesh/Mesh.cpp

${OBJECTDIR}/Sources/Mesh/CartesianOneDimMesh.o: Sources/Mesh/CartesianOneDimMesh.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Mesh
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Mesh/CartesianOneDimMesh.o Sources/Mesh/CartesianOneDimMesh.cpp
...
${OBJECTDIR}/Sources/Sections/DefaultTotalCrossSection.o: Sources/Sections/DefaultTotalCrossSection.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Sections/DefaultTotalCrossSection.o Sources/Sections/DefaultTotalCrossSection.cpp

${OBJECTDIR}/Sources/Mesh/Region.o: Sources/Mesh/Region.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Mesh
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Mesh/Region.o Sources/Mesh/Region.cpp

${OBJECTDIR}/Sources/Sections/FissionDistribution.o: Sources/Sections/FissionDistribution.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Sections
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Sections/FissionDistribution.o Sources/Sections/FissionDistribution.cpp

${OBJECTDIR}/Sources/Material/Geometry.o: Sources/Material/Geometry.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Material
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Material/Geometry.o Sources/Material/Geometry.cpp

${OBJECTDIR}/Sources/Solution/ScalarSource.o: Sources/Solution/ScalarSource.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Solution
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Solution/ScalarSource.o Sources/Solution/ScalarSource.cpp
...
${OBJECTDIR}/Sources/Solution/ScalarSolution.o: Sources/Solution/ScalarSolution.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Solution
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Solution/ScalarSolution.o Sources/Solution/ScalarSolution.cpp

${OBJECTDIR}/Sources/Sections/FissionCrossSection.o: Sources/Sections/FissionCrossSection.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Sections
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Sections/FissionCrossSection.o Sources/Sections/FissionCrossSection.cpp

${OBJECTDIR}/Sources/Sections/ProblemCrossSections.o: Sources/Sections/ProblemCrossSections.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Sections
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Sections/ProblemCrossSections.o Sources/Sections/ProblemCrossSections.cpp

${OBJECTDIR}/Sources/Sections/CrossSection.o: Sources/Sections/CrossSection.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Sections
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Sections/CrossSection.o Sources/Sections/CrossSection.cpp

${OBJECTDIR}/Sources/Solution/FissionSource.o: Sources/Solution/FissionSource.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Solution
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Solution/FissionSource.o Sources/Solution/FissionSource.cpp

${OBJECTDIR}/Sources/Solution/ReactionRate.o: Sources/Solution/ReactionRate.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Solution
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Solution/ReactionRate.o Sources/Solution/ReactionRate.cpp

${OBJECTDIR}/Sources/Sections/DefaultScatteringCrossSection.o: Sources/Sections/DefaultScatteringCrossSection.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Sections
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Sections/DefaultScatteringCrossSection.o Sources/Sections/DefaultScatteringCrossSection.cpp

${OBJECTDIR}/Sources/Solution/Flux.o: Sources/Solution/Flux.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Solution
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Solution/Flux.o Sources/Solution/Flux.cpp

${OBJECTDIR}/Sources/Material/Library.o: Sources/Material/Library.cpp 
	${MKDIR} -p ${OBJECTDIR}/Sources/Material
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sources/Material/Library.o Sources/Material/Library.cpp
